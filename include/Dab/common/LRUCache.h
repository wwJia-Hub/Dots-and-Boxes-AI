...
template <class TKey, class TValue, class THash>
bool ThreadSafeLRUCache<TKey, TValue, THash>::find(ConstAccessor& ac, const TKey& key) {
...
template <class TKey, class TValue, class THash>
bool ThreadSafeLRUCache<TKey, TValue, THash>::insert(const TKey& key, const TValue& value) {
  // Insert into the CHM
...
template <class TKey, class TValue, class THash>
void ThreadSafeLRUCache<TKey, TValue, THash>::snapshotKeys(std::vector<TKey>& keys) {
