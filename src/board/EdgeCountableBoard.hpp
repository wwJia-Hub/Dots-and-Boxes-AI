...
class EdgeCountableBoard : public HashBoard<BoardSize> {
  ...
  uint8_t EdgeCount(const Box<BoardSize> box) const;
...
template <int64_t BoardSize>
void EdgeCountableBoard<BoardSize>::Reset() {
...
template <int64_t BoardSize>
Edge<BoardSize> EdgeCountableBoard<BoardSize>::FindScoreableEdge() const {
...
template <int64_t BoardSize>
uint8_t EdgeCountableBoard<BoardSize>::EdgeCount(const Box<BoardSize> box) const {
  return Counter[box];
}
