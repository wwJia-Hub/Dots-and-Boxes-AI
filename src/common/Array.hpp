...
template <typename T, uint32_t Length>
constexpr uint32_t Array<T, Length>::Size() const {
  return Length;
}

template <typename T, uint32_t Length>
constexpr T* Array<T, Length>::begin() {
  return Data;
}

template <typename T, uint32_t Length>
constexpr const T* Array<T, Length>::begin() const {
  return Data;
}

template <typename T, uint32_t Length>
constexpr T* Array<T, Length>::end() {
  return Data + Length;
}

template <typename T, uint32_t Length>
constexpr const T* Array<T, Length>::end() const {
  return Data + Length;
}
