...
class MainWindowCreator {
  public:
  QPointer<QWidget> CreateMainWindow(const Config& config, QPointer<QWidget> parent = nullptr);

  private:
  template <int64_t BoardSize>
  QPointer<QWidget> CreateMainWindowImpl(const Config& config, QPointer<QWidget> parent);
};

template <int64_t MaxBoardSize>
inline QPointer<QWidget> MainWindowCreator<MaxBoardSize>::CreateMainWindow(const Config& config,
...
template <int64_t MaxBoardSize>
template <int64_t BoardSize>
QPointer<QWidget> MainWindowCreator<MaxBoardSize>::CreateMainWindowImpl(const Config& config,
                                                                        QPointer<QWidget> parent) {
